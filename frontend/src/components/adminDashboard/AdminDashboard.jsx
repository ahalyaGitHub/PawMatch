...
function AdminDashboard() {
  ...
  const handlePetsBoxClick = () => {
    navigate('/admin/pets'); // Redirect to AdminAdoptionRequest page
  };
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl">
        ...
        {/* Pet Box */}
        <div className="flex flex-col items-center justify-center bg-blue-200 hover:bg-blue-300 transition-all p-8 rounded-lg shadow-lg cursor-pointer" onClick={handlePetsBoxClick}>
